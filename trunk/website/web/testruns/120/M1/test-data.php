<?php 
	...
	$DESTDIR = $WRITEDIR . "testruns/120/M1/";
	$DESTFILE = $DESTDIR . "tests-ve1.2.txt";
?>
<html>
<head>
...
<?php
	...
	$sourcefile = "tests-ve1.2.txt.backup";
	
	if(!file_exists($DESTDIR)){
		mkdir($WRITEDIR . "testruns");
		mkdir($WRITEDIR . "testruns/120");
		mkdir($WRITEDIR . "testruns/120/final");
	}
