...
public class CompositeSourceContributor implements IVisualClassCreationSourceContributor {
	...
	public URL getTemplateLocation() {
		return FileLocator.find(SwtPlugin.getDefault().getBundle(), new Path("templates/org/eclipse/ve/internal/swt/codegen/jjet/wizards/contributors/CompositeSourceTemplate.javajet"), null);	} //$NON-NLS-1$
