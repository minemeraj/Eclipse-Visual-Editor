...
import org.eclipse.ve.sweet.fieldviewer.swt.internal.CompositeTableViewer;
...
public class CompositeTableViewerFactory implements IFieldViewerFactory {

	public IFieldViewer construct(Object control, IObjectViewer objectViewer,
			IPropertyEditor propertyEditor) {
		if (control instanceof CompositeTable) {
			return new CompositeTableViewer(control, objectViewer, propertyEditor);
		}
		return null;
	}
