 ...
 * @generated
 */
public class KeyedSizeImpl extends EObjectImpl implements BasicEMap.Entry<String,Dimension> {
	/**
	...
	protected EClass eStaticClass() {
		return CDMPackage.Literals.KEYED_SIZE;
	}
	 ...
	 * @generated
	 */
	public Dimension setValue(Dimension value) {
		Dimension oldValue = getValue();
		setTypedValue(value);
		return oldValue;
	}
	...
	public EMap<String, Dimension> getEMap() {
		EObject container = eContainer();
		return container == null ? null : (EMap<String, Dimension>)container.eGet(eContainmentFeature());
	}
