...
public class CopyOfSimpleTableBinding extends Composite {
	...
	public CopyOfSimpleTableBinding(Composite parent, int style)
	...
	private void bind() throws BindingException {
		...
		BindingContext bindingContext = dbs.getBindingContext(tableControl);
		bindingContext.setColumnCount(10);
		bindingContext.bindColumn("dateField", "propertyName");
		bindingContext.bindColumn(0, "propertyName");
		bindingContext.setColumnName(0, "propertyName");
		dbs.bind(uiContainer, "tableProperty", model, "collectionProperty", bindingContext);
		dbs.bind(control, model, "collectionProperty", bindingContext);

		Bindable bindableTable = dbs.getBindable(tableControl);
		//bindableTable.addColumn("dateField");
		bindableTable.setColumnSpec(2, new ComboCellEditor());
		Bindable bindableList = dbs.getBindable(object, "listPropertyName");
