 ...
 *******************************************************************************/
/*
 *  $RCSfile: JSplitPaneGraphicalEditPart.java,v $
...
public class JSplitPaneGraphicalEditPart extends ComponentGraphicalEditPart {
	...
	protected void createEditPolicies() {
		...
		// This is a special policy that just handles the size/position of visual components wrt/the figures. It does not handle changing size/position.
	...
	/**
	 * Sun let's you set the children in JSplitPane with just an add(aComponent, "left"), etc.,
	 * so we have to handle the cases whereas the components of the JSplitPane are constraint components.
	 */
