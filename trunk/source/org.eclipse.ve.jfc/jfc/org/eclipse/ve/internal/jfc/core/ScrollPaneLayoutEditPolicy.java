...
/*
 *  $RCSfile: ScrollPaneLayoutEditPolicy.java,v $
...
public class ScrollPaneLayoutEditPolicy extends LayoutEditPolicy {
	protected ScrollPaneContainerPolicy containerPolicy;

	public ScrollPaneLayoutEditPolicy(EditDomain anEditDomain) {
		containerPolicy = new ScrollPaneContainerPolicy(anEditDomain);
	}
