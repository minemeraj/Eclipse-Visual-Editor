...
public URL getTemplateLocation() {
	return JFCVisualPlugin.getPlugin().find(new Path("templates/org/eclipse/ve/internal/jfc/codegen/jjet/wizards/contributors/WindowDialogSourceTemplate.javajet")); //$NON-NLS-1$
}
