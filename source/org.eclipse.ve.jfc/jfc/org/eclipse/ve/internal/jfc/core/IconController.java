...
public class IconController {
	...
	private static final String PROJECT_SCOPE_START_STRING = "getClass().getResource("; //$NON-NLS-1$
	/** 
	...
	public IconController(
		...
		drawingBoard.addSelectionListener(new IconScreenDisplay.SelectionListener() {
	...
	private void updateSelectedImage(IPath fpath) {
		...
		if (currentScope == IconController.SEARCH_FILE_SYSTEM) {
			...
			setInitString("getClass().getResource(" + BeanUtilities.createStringInitString(relativePath.toString()) + ")"); //$NON-NLS-1$ //$NON-NLS-2$								
		}
	}
