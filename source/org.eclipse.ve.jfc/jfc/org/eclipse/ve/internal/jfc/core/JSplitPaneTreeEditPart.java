 ...
 *******************************************************************************/
/*
 *  $RCSfile: JSplitPaneTreeEditPart.java,v $
...
public class JSplitPaneTreeEditPart extends ComponentTreeEditPart {
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(
			...
			new org.eclipse.ve.internal.cde.core.TreeContainerEditPolicy(new JSplitPaneContainerPolicy(EditDomain.getEditDomain(this))));
	}
