...
/*
 *  $RCSfile: InverseMaintenanceAdapterSharedBeforePropagationTest.java,v $
...
/**
 * Tests for the Inverse Maintenance Adapter for Type (A) with (C) from InverseMaintenanceAdapter
 ...
 */
public class InverseMaintenanceAdapterSharedBeforePropagationTest extends TestCase {


	public InverseMaintenanceAdapterSharedBeforePropagationTest(String name) {
		super(name);
	}
	...
	public void testAddResourceOtherResourceAllowWithAdapter() {
		...
		ref1.setEOpposite(ref2);
		// Shouldn't do anything until propagate
		assertFalse(ia2.getFirstReferencedBy(EcorePackage.eINSTANCE.getEReference_EOpposite()) == ref1);		
