...
<table border=0 cellspacing=5 cellpadding=2 width="100%" >
  <tr> 
    <td align=left width="72%"> <font class=indextop> Visual Editor project<br>downloads</font> 
      <br>
      <font class=indexsub> latest downloads from the Visual Editor project</font><br>
		   <?php echo $warning; ?>
</td>
  ...
  <tr> 
    <td> 
      <p>On this page you can find the latest <a href="build_types.html">builds</a> 
        produced by the <a href="http://www.eclipse.org/vep" target="_top">Visual Eclipse 
        ...
        If you have problems installing or getting the Visual Editor to run, <a href="http://www.eclipse.org/vep/WebContent/faq.html" target="_top">check 
