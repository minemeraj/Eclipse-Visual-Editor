 ...
 *******************************************************************************/
/*
 *  $RCSfile: WindowGraphicalEditPart.java,v $
...
/**
 * Window graphical edit parts have special logic for visibility.  When instantiated on the tree form
 * they do not apply the visibility changes so that they always remain visible so we can
 * get their graphic and listen to them
 */
