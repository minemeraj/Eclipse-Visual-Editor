 ...
 *  $Revision: 1.1 $  $Date: 2005-04-26 21:39:19 $ 
 */
...
public URL getTemplateLocation() {
	return JFCVisualPlugin.getPlugin().find(new Path("templates/org/eclipse/ve/internal/jfc/codegen/jjet/wizards/contributors/ComponentSetSizeSourceTemplate.javajet")); //$NON-NLS-1$
}
