...
public class TextBinding extends Composite {
	...
	private void bind() throws BindingException {
		...
		dbs.bindContents(txtDescription,skiTrip,"description");
		dbs.bindContents(txtDescription_1,"text",skiTrip,"description");		
		
		dbs.bindContents(txtName,"text",skiTrip,"name");		
		dbs.bindContents(txtName_1,"text",skiTrip,"name");
		
		dbs.bindContents(txtLocation,"text",skiTrip,"location");		
		dbs.bindContents(txtLocation_1,"text",skiTrip,"location");		
