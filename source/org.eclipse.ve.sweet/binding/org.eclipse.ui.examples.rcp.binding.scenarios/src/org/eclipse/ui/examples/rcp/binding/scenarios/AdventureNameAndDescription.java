 ...
 *******************************************************************************/
/*
 *  $RCSfile: AdventureNameAndDescription.java,v $
 *  $Revision: 1.1 $  $Date: 2005-10-03 19:02:48 $ 
 */
		...
		adapter = new AdapterImpl() {
			public void notifyChanged(Notification notification) {
				if (!notification.isTouch()) {
					// We are only interested in "description" and "name" events being fired
					if(notification.getFeature() == AdventurePackage.eINSTANCE.getAdventure_Description() ||
					   notification.getFeature() == AdventurePackage.eINSTANCE.getAdventure_Name()){
						AdventureNameAndDescription.this.fireChangeEvent(IChangeEvent.CHANGE, null, null);						
					}
				}
