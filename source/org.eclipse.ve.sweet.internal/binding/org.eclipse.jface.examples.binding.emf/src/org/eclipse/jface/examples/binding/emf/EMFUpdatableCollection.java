...
public class EMFUpdatableCollection extends Updatable implements IUpdatableCollection {
	...
	private Adapter adapter = new AdapterImpl() {
		...
		public void notifyChanged(Notification msg) {
			...
			if (!updating && msg.getEventType() != Notification.REMOVING_ADAPTER &&
					         msg.getEventType() != Notification.REMOVING_ADAPTER) { //  A touch can designate a chile feature change
				if (msg.getNotifier() == object && msg.getFeature() == attribute) {
	...
	public EMFUpdatableCollection(EObject object, EStructuralFeature attribute, boolean oversensitiveListening) {
		this.object = object;
