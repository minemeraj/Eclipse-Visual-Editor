...
public class NumberBinding {
	...
	private void bind() {
		...
		dbc.bind(txtPrice,new Property(skiTrip, emfPackage.getAdventure_Price()), new BindSpec(new DoubleConverter(), null));
		dbc.bind(new Property(lblPrice, "text"), new Property(skiTrip, emfPackage.getAdventure_Price()), new BindSpec(new DoubleConverter(), null));
		dbc.bind(txtPrice_2, new Property(skiTrip, emfPackage.getAdventure_Price()), new BindSpec(new DoubleConverter(), null));
