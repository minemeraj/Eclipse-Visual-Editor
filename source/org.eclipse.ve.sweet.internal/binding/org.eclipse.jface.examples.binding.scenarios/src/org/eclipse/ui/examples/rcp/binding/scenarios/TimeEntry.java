...
public class TimeEntry extends Composite {
	...
	private void initialize() {
		...
		spin_hours.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
		...
		spin_minutes.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				fireChanged();
			}
		});		
