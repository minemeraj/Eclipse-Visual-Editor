...
public class LabelBinding extends Composite {
	...
	private void bind() throws BindingException{
		...
		dbs.bindContents(txtName,skiTrip,emfPackage.getAdventure_Name());
		dbs.bindContents(lblName,skiTrip,emfPackage.getAdventure_Name());
		
		dbs.bindContents(txtDescription,skiTrip,emfPackage.getAdventure_Description());
		dbs.bindContents(lblDescription,skiTrip,emfPackage.getAdventure_Description());
