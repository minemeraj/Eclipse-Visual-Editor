...
public class TextCustomBinding extends Composite {
	...
	private void bind() throws BindingException{
		...
		dbs.bindContents(txtDescription,"text",skiTrip,"description");
		...
		dbs.bindContents(txtCustom,customUpdatable);
		
		dbs.bindContents(txtDescription_1,skiTrip,"description");
		dbs.bindContents(txtName_1,skiTrip,"name");
		...
		dbs.bindContents(txtCustom_1,customUpdatable_1);		
